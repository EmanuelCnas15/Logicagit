...
let everyFilmes = filmes.every(function(filme){
    return filme.ano >= 1990;
})
console.log(everyFilmes);
let someFilmes = filmes.some(function(filme){
    return filme.ano >= 1990;
})
console.log(someFilmes);   
let filterFilmes = filmes.filter(function(filme){
    return filme.ano >= 1990;
})
